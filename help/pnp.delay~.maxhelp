...
, 							{
								"box" : 								{
									...
									"text" : "pnp.delay~ is a variable delay line. The delay time can be specified in milliseconds and changed in real-time to create delay times of different lengths. An optional argument, window size, can be specified but defaults to 256 if left unspecified.",
