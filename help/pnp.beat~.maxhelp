...
, 							{
								"box" : 								{
									...
									"text" : "This object reports onset in an incoming signal as bangs, as well as the velocity of each reported onset as a normalized floating point number between 0-1."
								}
