...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 48.543688654899597, 127.213591873645782, 687.0, 33.0 ],
									"text" : "This effect splits an audio signal using an FFT at a specified frequency bin. The object defaults to a frame size of 2048, so a number range between 0 and 1024 should be used.",
									"textcolor" : [ 0.843137254901961, 0.843137254901961, 0.843137254901961, 1.0 ]
								}
