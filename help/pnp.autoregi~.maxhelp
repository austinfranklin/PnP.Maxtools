...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 255.0, 353.0, 186.0, 19.0 ],
									"text" : "remove trough hand peak inlets!"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 48.543688654899597, 123.213591873645782, 518.0, 58.0 ],
									"text" : "This object returns a normalized floating point number that indicates where the detected pitch is located between detected low and high frequency arguments. The object sets the low and high frequency arguments automatically using pitch detection. The smoothness argument can be used to output a more gradual change in output."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 48.543688654899597, 88.213591873645782, 518.0, 32.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 150.0, 536.0, 112.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 346.0, 503.0, 150.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 353.077669024467468, 439.0, 172.0, 32.0 ],
									"text" : "1. Trough frequency (optional)\n2. Peak frequency (optional)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 353.077669024467468, 417.0, 172.0, 19.0 ],
									"text" : "Arguments:"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 150.0, 227.0, 225.0, 95.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 250.0, 503.0, 88.0, 21.0 ],
									"text" : "0 0"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 319.0, 385.0, 50.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 234.5, 385.0, 50.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 150.0, 437.0, 188.0, 21.0 ],
									"text" : "pnp.autoregi~",
									"varname" : "aaf.amp~"
								}
