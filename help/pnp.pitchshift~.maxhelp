...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 119.679611504077911, 199.5, 241.0, 110.5 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 159.679611504077911, 339.0, 145.0, 20.0 ],
									"text" : "Semi-Tone Transposition",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 209.679611504077911, 361.0, 45.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 119.679611504077911, 402.0, 109.0, 22.0 ],
									"text" : "pnp.pitchshift~ 7",
									"varname" : "aaf.amp~"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "pnp.pitchshift~ is a pitchshifter that uses an FFT to transpose an incoming signal using semi tones, where an increase by 1 is an transposition factor of 1 semitone. Setting negative values transposes the resulting pitch down. The object semitone argument defaults to 0 if unspecified.",
...
, 							{
								"box" : 								{
									...
									"text" : "Pitchshifts an incoming audio signal",
									"textcolor" : [ 0.16078431372549, 0.152941176470588, 0.176470588235294, 1.0 ]
								}
...
,
					"patching_rect" : [ 169.300960958003998, 140.262129187583923, 49.0, 22.0 ],
...
,
		...
		"parameters" : 		{
			...
			"obj-41::obj-5::obj-4::obj-21::obj-6" : [ "live.tab[3]", "live.tab[1]", 0 ],
			"obj-41::obj-5::obj-4::obj-35" : [ "[5]", "Level", 0 ],
			"parameterbanks" : 			{
