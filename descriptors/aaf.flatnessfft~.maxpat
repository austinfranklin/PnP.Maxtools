...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 617.441838383674622, 603.488350510597229, 41.0, 22.0 ],
					"text" : "sig~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 737.209275960922241, 687.209277749061584, 38.0, 22.0 ],
					"text" : "pow~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 835.99999988079071, 584.898922920227051, 139.950623989105225, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 710.450616836547852, 760.523149847984314, 29.5, 22.0 ],
					"text" : "!/~"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 232.0, 20.0, 28.0, 22.0 ],
									"text" : "in 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 83.0, 71.0, 67.0, 22.0 ],
									"text" : "history fb 1"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-6", 0 ],
									"midpoints" : [ 59.5, 145.0, 36.0, 145.0, 36.0, 66.0, 92.5, 66.0 ],
									"order" : 0,
									"source" : [ "obj-5", 0 ]
								}
...
,
					"patching_rect" : [ 835.99999988079071, 543.378351092338562, 36.0, 22.0 ],
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 334.666676640510559, 865.333359122276306, 110.769201517105103, 20.0 ],
					"text" : "works the best"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 645.333352565765381, 390.518543243408203, 151.0, 60.0 ],
					"text" : "works very well, but may not be accurate? does it work better with the actual geometric mean?"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 308.473696708679199, 935.578980565071106, 60.0, 22.0 ],
					"text" : "clip~ 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 718.083638191223145, 865.261226534843445, 115.246919989585876, 22.0 ],
					"text" : "sah~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 668.062511324882507, 651.336440563201904, 29.5, 22.0 ],
					"text" : "/~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 718.083638191223145, 995.226224422454834, 35.0, 22.0 ],
					"text" : "out 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 308.435878157615662, 891.056102633476257, 137.0, 22.0 ],
					"text" : "scale~ 0. 100. 1. 0. 0.25"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 119.493839979171753, 920.543281197547913, 115.246919989585876, 22.0 ],
					"text" : "sah~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 345.809903740882874, 608.197573900222778, 53.0, 22.0 ],
					"text" : "==~ 627"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 119.486527442932129, 830.197872400283813, 47.0, 22.0 ],
					"text" : "*~ 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 119.486527442932129, 781.037097215652466, 29.5, 22.0 ],
					"text" : "/~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 119.486527442932129, 872.248317241668701, 35.0, 22.0 ],
					"text" : "abs~"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 306.0, 34.0, 22.0 ],
									"text" : "latch"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 194.0, 29.0, 28.0, 22.0 ],
									"text" : "in 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 78.0, 92.0, 44.0, 22.0 ],
									"text" : "history"
								}
...
,
					"patching_rect" : [ 119.486527442932129, 733.317602634429932, 36.0, 22.0 ],
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 599.999992847442627, 467.565586090087891, 139.950623989105225, 22.0 ],
					"sig" : 0.0
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 320.0, 29.0, 22.0 ],
									"text" : "sqrt"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 83.0, 71.0, 44.0, 22.0 ],
									"text" : "history"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 51.0, 374.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 599.999992847442627, 409.518543243408203, 36.0, 22.0 ],
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 88.881583452224731, 589.765432000160217, 29.5, 22.0 ],
					"text" : "!/~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 308.473696708679199, 982.128796458244324, 35.0, 22.0 ],
