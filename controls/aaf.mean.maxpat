...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "calculate mean median, mode, and range"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 659.0, 562.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 628.0, 451.0, 50.0, 22.0 ],
					"text" : "1"
				}
...
,
					"patching_rect" : [ 786.0, 363.0, 91.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 786.0, 391.0, 91.0, 93.0 ],
					"range" : 15,
					"size" : 5,
					"table_data" : [ 0, 5, 2, 4, 2, 2 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 659.0, 302.0, 76.0, 22.0 ],
					"text" : "zl.stream 15"
				}
...
,
					"patching_rect" : [ 659.0, 361.0, 80.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 659.0, 415.0, 43.0, 22.0 ],
					"text" : "zl.sort"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 718.0, 415.0, 50.0, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 406.5, 490.0, 29.0, 22.0 ],
					"text" : "sqrt"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 406.5, 562.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 313.0, 370.0, 29.5, 22.0 ],
					"text" : "!/ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 342.5, 431.0, 29.5, 22.0 ],
					"text" : "* 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 293.0, 291.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 293.0, 334.0, 39.0, 22.0 ],
					"text" : "mean"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 503.5, 165.0, 42.0, 22.0 ],
					"text" : "t b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 503.5, 216.0, 75.5, 22.0 ],
					"text" : "0.983418"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 503.5, 91.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 330.5, 466.0, 31.0, 22.0 ],
					"text" : "float"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 380.5, 216.0, 29.5, 22.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.5, 91.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 353.0, 291.0, 57.0, 22.0 ],
					"text" : "accum 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.5, 562.0, 25.0, 25.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 513.0, 276.0, 362.5, 276.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-22", 0 ],
					"midpoints" : [ 536.0, 201.0, 302.5, 201.0 ],
					"source" : [ "obj-15", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 524.5, 418.0, 432.0, 418.0, 432.0, 418.0, 340.0, 418.0 ],
					"source" : [ "obj-15", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 0 ],
					"midpoints" : [ 362.5, 324.0, 302.5, 324.0 ],
					"order" : 2,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 390.0, 201.0, 489.0, 201.0, 489.0, 201.0, 569.5, 201.0 ],
					"order" : 0,
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 390.0, 276.0, 362.5, 276.0 ],
					"source" : [ "obj-7", 0 ]
				}
