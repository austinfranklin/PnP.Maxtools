...
,
		"classnamespace" : "box",
		"rect" : [ -1153.0, 192.0, 1042.0, 787.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 426.010767817497253, 146.806465983390808, 183.0, 22.0 ],
					"text" : "if $i1 == 0 then 256 else out2 $i1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 425.946601688861847, 111.5939000248909, 77.0, 22.0 ],
					"text" : "loadmess #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 76.010767817497253, 390.806465983390808, 183.0, 22.0 ],
					"text" : "if $i1 == 0 then 256 else out2 $i1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.946601688861847, 355.5939000248909, 83.0, 22.0 ],
					"text" : "loadmess #1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 56.66155594587326, 224.0, 79.0, 22.0 ],
					"text" : "tapin~ 20000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 365.0, 727.0, 258.0, 20.0 ],
					"text" : "modified version of Benjamin Thigpen's vdb~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 56.66155594587326, 676.0, 199.5, 22.0 ],
					"text" : "+~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 237.0, 616.0, 75.0, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 56.66155594587326, 625.0, 75.0, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 56.66155594587326, 579.0, 199.33844405412674, 22.0 ],
					"text" : "tapout~ 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 76.0, 471.0, 31.0, 22.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 76.0, 523.0, 75.0, 22.0 ],
					"text" : "sah~ 0.0001"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 237.0, 523.0, 75.0, 22.0 ],
					"text" : "sah~ 0.0001"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 365.0, 435.0, 33.0, 22.0 ],
					"text" : "!-~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 365.0, 360.0, 43.0, 22.0 ],
					"text" : "+~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 365.0, 321.0, 40.0, 22.0 ],
					"text" : "*~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 365.0, 259.0, 90.0, 22.0 ],
					"text" : "cycle~ 13.3333"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 365.0, 226.0, 49.0, 22.0 ],
					"text" : "!/ 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 365.0, 193.0, 61.0, 22.0 ],
					"text" : "maximum"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 185.66155594587326, 75.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 56.66155594587326, 727.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 56.66155594587326, 75.0, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 249.510767817497253, 430.0, 85.5, 430.0 ],
					"source" : [ "obj-21", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"midpoints" : [ 195.16155594587326, 456.0, 85.5, 456.0 ],
					"source" : [ "obj-3", 0 ]
				}
