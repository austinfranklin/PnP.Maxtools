...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 172.5, 155.0, 47.0, 22.0 ],
					"text" : ">~ -60."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 172.5, 120.0, 46.0, 22.0 ],
					"text" : "atodb~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "signal" ],
					"patching_rect" : [ 100.5, 87.0, 91.0, 22.0 ],
					"text" : "pnp.amplitude~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 144.393424987792059, 432.0, 537.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 300.0, 328.0, 29.5, 22.0 ],
					"text" : "int"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 424.143424987792059, 247.0, 29.5, 22.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 73.0, 384.0, 53.0, 22.0 ],
					"text" : "clip 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 36.0, 334.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 192.73077780008316, 90.0, 22.0 ],
					"text" : "loadmess 3000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 287.0, 361.0, 56.0, 20.0 ],
					"text" : "bin #"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 318.0, 220.0, 64.0, 20.0 ],
					"text" : "frequency"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 444.985530853270575, 141.4998683540191, 87.0, 20.0 ],
					"text" : "Sampling Rate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 395.143426179884955, 293.872418582439423, 68.0, 20.0 ],
					"text" : "Hz per Bin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 374.985530853270575, 141.4998683540191, 68.0, 22.0 ],
					"text" : "adstatus sr"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 73.0, 234.234523236751556, 171.0, 22.0 ],
					"text" : "pfft~ pnp.brightnessfft~ 2048 4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 73.0, 432.0, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 444.143424987792059, 279.0, 320.0, 279.0 ],
					"source" : [ "obj-3", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 433.643424987792059, 279.0, 309.5, 279.0 ],
					"source" : [ "obj-3", 0 ]
				}
