...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 145.0, 470.0, 47.0, 22.0 ],
					"text" : "*~ 0.04"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 284.0, 145.0, 64.0, 22.0 ],
					"text" : "delay~ 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 260.0, 211.0, 64.0, 22.0 ],
					"text" : "delay~ 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 284.0, 105.0, 40.0, 22.0 ],
					"text" : "==~ 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 145.0, 233.0, 30.0, 22.0 ],
					"text" : "+=~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 145.0, 178.0, 76.5, 22.0 ],
					"text" : "cartopol~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 145.0, 318.0, 64.5, 22.0 ],
					"text" : "/~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 271.0, 288.459458827972412, 29.5, 22.0 ],
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 260.0, 323.0, 30.0, 22.0 ],
					"text" : "==~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 364.5, 174.0, 50.5, 22.0 ],
					"text" : "fftinfo~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 145.0, 409.0, 134.0, 22.0 ],
					"text" : "sah~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 145.0, 514.0, 78.0, 22.0 ],
					"text" : "fftout~ 1 nofft"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 145.0, 62.0, 134.0, 22.0 ],
					"text" : "fftin~ 1"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 293.5, 129.0, 293.5, 129.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 293.5, 198.0, 231.0, 198.0, 231.0, 219.0, 165.5, 219.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 384.5, 263.0, 280.5, 263.0 ],
					"order" : 0,
					"source" : [ "obj-59", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 384.5, 247.0, 200.0, 247.0 ],
					"order" : 1,
					"source" : [ "obj-59", 1 ]
				}
