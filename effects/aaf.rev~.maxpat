...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 293.0, 235.575044549583254, 123.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 642.015358150005341, 147.471579432487488, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 544.0, 310.0, 93.0, 24.0 ],
					"text" : "yafr2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 642.015358150005341, 171.471579432487488, 28.969283699989205, 22.0 ],
					"preset_data" : [ 						{
							"number" : 1,
							"data" : [ 5, "<invalid>", "slider", "float", 44.0, 5, "<invalid>", "slider", "float", 127.0, 5, "<invalid>", "slider", "float", 50.0, 5, "<invalid>", "slider", "float", 58.0 ]
						}
, 						{
							"number" : 2,
							"data" : [ 5, "<invalid>", "slider", "float", 0.0, 5, "<invalid>", "slider", "float", 69.0, 5, "<invalid>", "slider", "float", 89.0, 5, "<invalid>", "slider", "float", 97.0 ]
						}
, 						{
							"number" : 3,
							"data" : [ 5, "<invalid>", "slider", "float", 0.0, 5, "<invalid>", "slider", "float", 69.0, 5, "<invalid>", "slider", "float", 89.0, 5, "<invalid>", "slider", "float", 97.0 ]
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 642.015358150005341, 121.471579432487488, 65.0, 24.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 623.0, 235.575044549583254, 65.0, 20.0 ],
					"text" : "decay time"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 623.0, 282.575044549583254, 53.0, 20.0 ],
					"text" : "diffusion"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 623.0, 258.575044549583254, 132.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 623.0, 212.575044549583254, 67.0, 20.0 ],
					"text" : "size"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 618.0, 258.575044549583254, 142.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 618.0, 235.575044549583254, 142.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 618.0, 212.575044549583254, 142.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 618.0, 282.575044549583254, 142.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 441.0, 311.0, 61.0, 22.0 ],
					"text" : "yafr2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.66936844587326, 581.0, 30.0, 30.0 ]
				}
